...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Apr 2021 pada 11.04
...
(4, 'Jenis', 2000),
(5, 'paket wangi dan bersih', 15000),
(6, 'paket wangi', 3000),
(7, 'paket wangi', 3000);
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama_pelanggan`, `alamat`, `telp`, `jeniskelamin`) VALUES
(1, 'Sultan', 'Cisarua', '08876322', 'laki-laki'),
(2, 'KimSul', 'Cisarua', '81765411', 'laki-laki'),
(5, 'Ryujin', 'Seoul', '817655625452', 'laki-laki'),
(6, 'NC.A', 'Seoul', '81752675672', 'laki-laki'),
(8, 'Fair Xing', 'Hulunbuir,Republik Rakyat Tiongkok', '16923874235', 'laki-laki'),
(9, 'yudi', 'batujajar08', '08124357809', 'laki-laki'),
(10, 'gygy', 'sulawesi', '8534678', 'perempuan'),
(11, 'dadang', 'kp jajan horeng', '089691633797', 'laki-laki'),
(12, 'syahrul', 'bandung', '08654262976', 'laki-laki');
...
(6, 8, 'Sultan', '2021-03-31', '2021-03-30', 8000, 20000, 12000, 'Lunas', 2, 'Cuci Kering + Cuci Basah', 0, 1, 'cek cok', 'Diberikan'),
(7, 9, 'yudi', '2021-03-31', '2021-03-10', 7500, 20000, 12500, 'Lunas', 3, 'Cuci Basah + Parfum', 0, 3, 'diambil jam 5', 'Diambil'),
(8, 10, 'yudi', '2021-04-02', '2021-04-08', 15000, 20000, 5000, 'Lunas', 3, 'Cuci Basah + Parfum', 7500, 2, 'diambil siang', 'Diambil'),
(9, 10, 'Sultan', '2021-04-02', '2021-04-02', 8000, 10000, 2000, 'Lunas', 2, 'Cuci Kering + Cuci Basah', 8000, 1, 'mohon bersih', 'null'),
(10, 11, 'dadang', '2021-04-02', '2021-04-02', 15000, 20000, 5000, 'Lunas', 3, 'Cuci Basah + Parfum', 7500, 2, 'mohon wangi', 'null'),
(11, 12, 'yudi', '2021-04-02', '2021-04-10', 30000, 50000, 20000, 'Lunas', 5, 'paket wangi dan bersih', 15000, 2, 'mohon di pack dengan rapih', 'null');
...
(8, 'user', 'user', '', 'Ini User'),
(9, 'abcfd', 'xcvb', 'admin', 'tesa faerani'),
(10, 'owner', 'owner', 'owner', 'yayat'),
(11, 'abcd', '2222', 'admin', 'feby a'),
(12, 'tgfr', '55555', 'admin', 'kulunu'),
(13, 'caca', '8888', 'kasir', 'kunu'),
(14, 'kulunu', '2345', 'kasir', 'syalala'),
(15, 'caca', '23456', 'owner', 'acacaca');
...
--
ALTER TABLE `penerimaan`
  MODIFY `no_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
