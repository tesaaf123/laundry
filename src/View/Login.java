...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/icons8-administrator-male-40.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View.Icon/icons8-lock-20.png"))); // NOI18N
        ...
        masukpelanggan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View.Icon/exit.png"))); // NOI18N
        ...
        b_login.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View.Icon/icons8-enter-25.png"))); // NOI18N
       ...
       try{
            ...
            if(rs.next()){
                if (db_password.getText().equals(rs.getString("password"))) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Selamat Datang " + namaDisplay);
                    this.setVisible(false);
                    home_kasir objL = new home_kasir("Selamat Datang " + namaDisplay);
                    objL.setVisible(true);
                    
                }
                    if (ownerType.equals(rs.getString("hakakses"))) {
                        String namaDisplay = rs.getString("nama_pengguna");
                    JOptionPane.showMessageDialog(rootPane, "Selamat Datang " + namaDisplay);
                    this.setVisible(false);
                    home_owner objL = new home_owner("Selamat Datang " + namaDisplay);
                    objL.setVisible(true);
            }
            }else {
